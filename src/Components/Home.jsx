...
const Home = () => {
  return (
    ...
    <div name="home" className="h-screen color-content">
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        ...
        <h1 className="text-4xl group sm:text-6xl font-bold text-[#1c1c21]">
         ...
         <h2 className="text-2xl sm:text-5xl type_css font-bold text-[#6a62d5]">
          <span className="typed-text text-[#6a62d5]-600">
            <Typewriter
              onInit={(typewriter) => {
                typewriter
        ...
        <p className="text-[#262628] glow2 glass text-1xl py-4 max-w-[700px]">
        ...
        <div>
          <li>
            <Link to="about" smooth={true} duration={500}>
              <button className=" group px-6 py-3 my-2 flex border-2 border-zinc-900 text-[#020205] items-center hover:bg-[#6a62d5] ">
                view more
